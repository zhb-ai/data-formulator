...
# Built-in providers whose endpoint type equals their lowercase name.
...
class ModelRegistry:
    ...
    def _reload(self) -> None:
        ...
        for provider in self._discover_providers():
            ...
            # The endpoint type controls which client library is used.
            # Built-in providers use their own name; custom providers default
            # to "openai" (OpenAI-compatible REST API).
            ...
            for model_name in models_str.split(","):
                ...
                self._models[model_id] = {
                    ...
                    # Keep the display name separate from the endpoint type.
